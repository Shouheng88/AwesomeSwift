...
struct SampleData {
    ...
    private static let items: [SampleItem] = [
        ...
        SampleItem(name: "图片", destination: ImageDemoView()),
        SampleItem(name: "图片-选择", destination: ImagePickDemoView()),
        ...
        SampleItem(name: "对话框", destination: AlertDemoView()),
        ...
        SampleItem(name: "更新提示（三方控件）", destination: WhatsNewKitView()),
        SampleItem(name: "顶部通知（三方控件）", destination: NotificationBannerView()),
        ...
        SampleItem(name: "文件-选择", destination: DocumentPickerDemoView()),
